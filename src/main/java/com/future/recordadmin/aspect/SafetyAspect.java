package com.future.recordadmin.aspect;
...
import com.future.recordadmin.util.AesUtil;
import com.future.recordadmin.util.ErrorUtil;
import com.future.recordadmin.util.RsaUtil;
...
public class SafetyAspect {
     ...
     * Pointcut 切入点
     * 匹配
     * com.future.recordadmin.sys.*.controller、
     * com.future.recordadmin.*.controller包下面的所有方法
     */
    @Pointcut(value = "execution(public * com.future.recordadmin.sys.*.controller.*.*(..)) || " +
            "execution(public * com.future.recordadmin.*.controller.*.*(..))")
